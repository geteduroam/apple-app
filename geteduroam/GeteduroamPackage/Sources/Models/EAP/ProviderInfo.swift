...
#if DEBUG
public let demoProviderInfo = ProviderInfo(displayName: [.init(language: nil, value: "Demo Provider")], description: [.init(language: "en", value: "English information about the demo provider.")], providerLocations: [.init(latitude: 12, longitude: 34)], providerLogo: LogoData(value: "data", mime: "mime", encoding: "encoding"), termsOfUse: [.init(language: "any", value: "You must behave yourself at all times.")], helpdesk: .init(emailAdress: [.init(language: "any", value: "hello@provider.info")], webAddress: [.init(language: "nl", value: "https://www.example.com/nl/"), .init(language: "any", value: "https://www.example.com/")], phone: [.init(language: nil, value: "+31551234567")]))
#endif
