...
final class ConnectTests: XCTestCase {
    ...
    let demoInstance = Organization(id: "cat_7016", name: [LocalizedEntry(display: "Môreelsepark Cöllege")], country: "NL", profiles: [
        Profile(id: "letswifi_cat_7830", name: [LocalizedEntry(display: "Mijn Moreelsepark")], default: true, letsWiFiEndpoint: ConnectTests.letsWifiEndpoint, type: .letswifi),
        Profile(id: "profile2", name: [LocalizedEntry(display: "Profile")], eapConfigEndpoint: ConnectTests.eapConfigEndpoint, type: .eapConfig)
    ])
